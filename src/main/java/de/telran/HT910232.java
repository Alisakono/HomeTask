...
public class HT910232 {
    public static void main(String[] args) {
        Random rnd = new Random();
        int s = rnd.nextInt(28800), w = s / 60 / 60;
        System.out.println("Секунд осталось: "+s);
        switch (w){
            case 0:
                System.out.println("До конца рабочего дня осталось меньше час.");
                break;
            case 1:
                System.out.println("До конца рабочего дня остался "+ w +" час");
                break;
            case 2:
                System.out.println("До конца рабочего дня остался "+ w +" час");
                break;
